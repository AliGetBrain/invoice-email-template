...
const subject = `
Invoice #{{#each invoiceData}}{{invoiceNumber}}{{#unless @last}},{{/unless}}{{/each}}- Client: {{contactCompanyName}}, Past 60 Days Due
`;
...
<body
    ...
    <div
        ...
        <p style="margin: 0 0 16px 0; font-size: 1rem; line-height: 1.6">
            The following invoices are over 60 days past due for {{contactCompanyName}}, <span style="font-weight: 600; color: #374151;">Customer #{{customerNumber}}:</span>
        </p>
       ...
       <table cellpadding="0" cellspacing="0" border="0" width="100%" style="
        ...
        <p style="margin-bottom: 12px; font-size: 1rem;">
           All automated outreach has been paused for these invoices. Please escalate and resolve these invoices with the client immediately.
        </p>
...
function generateAndSaveHTML() {
  try {
    ...
    const outputFile = path.join(__dirname, "high_risk_overdue.html");
