              ...
              <tbody>
                {{#each lineItems}}
                  <tr>
                    ...
                    <td style="padding: 16px; border-bottom: 1px solid #e5e7eb; color: #4b5563; text-align: center;">{{format rate}}</td>
                    <td style="padding: 16px; border-bottom: 1px solid #e5e7eb; color: #4b5563; text-align: center;">{{format amount}}</td>
                  </tr>
                {{/each}}
              </tbody>
            </table>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin-left: auto;">
                      {{#if (greaterThan lineItems.length 2)}}
                          {{#if subTotal}}
                            <tr>
                                ...
                                <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">{{format subTotal}}</td>
                            </tr>
                          {{/if}}
                      {{/if}}
                      ...
                      {{#if discounts}}
                        <tr>
                            ...
                            <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">- {{format discounts}}</td>
                        </tr>
                      {{/if}}
                        {{#if totalTax}}<tr>
                            <td style="padding: 8px 0; font-size: 0.95rem;">TAX </td>
                            <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">{{format totalTax}}</td>
                        </tr>
                      {{/if}}
                      ...
                      {{#if shippingAmount}}
                        <tr>
                            ...
                            <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">{{format shippingAmount}}</td>
                        </tr>
                      {{/if}}
                      ...
                      {{#if totalAmount}}
                        <tr>
                            ...
                            <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">{{format totalAmount}}</td>
                        </tr>    
                      {{/if}}  
                      {{#if amountPaid}}      
                        <tr>
                            <td style="padding: 8px 0; font-size: 0.95rem;">PAYMENTS</td>
                            <td style="padding: 8px 20px 8px 0; font-size: 0.95rem; text-align: right;">- {{format amountPaid}}</td>
                        </tr> 
                      {{/if}}  
                       {{#if balanceDue}}   
                      <tr>
